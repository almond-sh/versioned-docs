---
title: docker
id: version-0.14.0-RC8-try-docker
...
```
$ docker run -it --rm -p 8888:8888 almondsh/almond:v0.14.0-RC8
```

Run a specific version with a specific Scala version with
```
$ docker run -it --rm -p 8888:8888 almondsh/almond:v0.14.0-RC8-scala-2.13.11
```
