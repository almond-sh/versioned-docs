---
title: Spark
id: version-0.14.0-RC8-usage-spark
...
import $ivy.`sh.almond::almond-spark:0.14.0-RC8` // Not required since almond 0.7.0 (will be automatically added when importing spark)
```
