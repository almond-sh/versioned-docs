...
id: version-0.5.0-api-access-instances
...
- `com.lihaoyi:ammonite-interp_2.12.8:1.6.7` for [`ammonite.interp.InterpAPI`](api-ammonite.md#interpapi),
- `com.lihaoyi:ammonite-repl_2.12.8:1.6.7` for [`ammonite.repl.ReplAPI`](api-ammonite.md#replapi),
- `sh.almond:scala-kernel-api_2.12.8:0.5.0` for [`almond.api.JupyterAPI`](api-jupyter.md#jupyterapi).
...
libraryDependencies ++= Seq(
  ("com.lihaoyi" % "ammonite-interp" % "1.6.7" % Provided).cross(CrossVersion.full), // for ammonite.interp.InterpAPI
  ("com.lihaoyi" % "ammonite-repl" % "1.6.7" % Provided).cross(CrossVersion.full), // for ammonite.repl.ReplAPI
  ("sh.almond" % "scala-kernel-api" % "0.5.0" % Provided).cross(CrossVersion.full) // for almond.api.JupyterAPI
)
```
