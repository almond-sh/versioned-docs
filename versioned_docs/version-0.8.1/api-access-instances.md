...
id: version-0.8.1-api-access-instances
...
- `com.lihaoyi:ammonite-interp_2.12.8:1.7.1` for [`ammonite.interp.InterpAPI`](api-ammonite.md#interpapi),
- `com.lihaoyi:ammonite-repl_2.12.8:1.7.1` for [`ammonite.repl.ReplAPI`](api-ammonite.md#replapi),
- `sh.almond:scala-kernel-api_2.12.8:0.8.1` for [`almond.api.JupyterAPI`](api-jupyter.md#jupyterapi).
...
libraryDependencies ++= Seq(
  ("com.lihaoyi" % "ammonite-interp" % "1.7.1" % Provided).cross(CrossVersion.full), // for ammonite.interp.InterpAPI
  ("com.lihaoyi" % "ammonite-repl" % "1.7.1" % Provided).cross(CrossVersion.full), // for ammonite.repl.ReplAPI
  ("sh.almond" % "scala-kernel-api" % "0.8.1" % Provided).cross(CrossVersion.full) // for almond.api.JupyterAPI
)
```
