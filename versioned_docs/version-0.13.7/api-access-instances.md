...
id: version-0.13.7-api-access-instances
...
- `sh.almond:scala-kernel-api_2.13.10:0.13.7` for [`almond.api.JupyterApi`](api-jupyter.md#jupyterapi).
...
libraryDependencies ++= Seq(
  ...
  ("sh.almond" % "scala-kernel-api" % "0.13.7" % Provided).cross(CrossVersion.full) // for almond.api.JupyterApi
)
```
