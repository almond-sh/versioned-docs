...
id: version-0.13.11-api-access-instances
...
- `com.lihaoyi:ammonite-interp_2.13.10:3.0.0-M0-19-62705f47` for [`ammonite.interp.api.InterpApi`](api-ammonite.md#interpapi),
- `com.lihaoyi:ammonite-repl_2.13.10:3.0.0-M0-19-62705f47` for [`ammonite.repl.api.ReplAPI`](api-ammonite.md#replapi),
- `sh.almond:scala-kernel-api_2.13.10:0.13.11` for [`almond.api.JupyterApi`](api-jupyter.md#jupyterapi).
...
libraryDependencies ++= Seq(
  ("com.lihaoyi" % "ammonite-interp" % "3.0.0-M0-19-62705f47" % Provided).cross(CrossVersion.full), // for ammonite.interp.api.InterpApi
  ("com.lihaoyi" % "ammonite-repl" % "3.0.0-M0-19-62705f47" % Provided).cross(CrossVersion.full), // for ammonite.repl.api.ReplAPI
  ("sh.almond" % "scala-kernel-api" % "0.13.11" % Provided).cross(CrossVersion.full) // for almond.api.JupyterApi
)
```
