...
id: version-0.9.0-api-access-instances
...
- `sh.almond:scala-kernel-api_2.12.8:0.9.0` for [`almond.api.JupyterAPI`](api-jupyter.md#jupyterapi).
...
libraryDependencies ++= Seq(
  ...
  ("sh.almond" % "scala-kernel-api" % "0.9.0" % Provided).cross(CrossVersion.full) // for almond.api.JupyterAPI
)
```
