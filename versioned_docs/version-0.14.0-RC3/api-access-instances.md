...
id: version-0.14.0-RC3-api-access-instances
...
- `com.lihaoyi:ammonite-interp_2.13.11:3.0.0-M0-32-96e851cb` for [`ammonite.interp.api.InterpApi`](api-ammonite.md#interpapi),
- `com.lihaoyi:ammonite-repl_2.13.11:3.0.0-M0-32-96e851cb` for [`ammonite.repl.api.ReplAPI`](api-ammonite.md#replapi),
- `sh.almond:scala-kernel-api_2.13.11:0.14.0-RC3` for [`almond.api.JupyterApi`](api-jupyter.md#jupyterapi).
...
libraryDependencies ++= Seq(
  ("com.lihaoyi" % "ammonite-interp" % "3.0.0-M0-32-96e851cb" % Provided).cross(CrossVersion.full), // for ammonite.interp.api.InterpApi
  ("com.lihaoyi" % "ammonite-repl" % "3.0.0-M0-32-96e851cb" % Provided).cross(CrossVersion.full), // for ammonite.repl.api.ReplAPI
  ("sh.almond" % "scala-kernel-api" % "0.14.0-RC3" % Provided).cross(CrossVersion.full) // for almond.api.JupyterApi
)
```
