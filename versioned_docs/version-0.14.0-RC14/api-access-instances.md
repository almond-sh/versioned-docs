...
id: version-0.14.0-RC14-api-access-instances
...
- `com.lihaoyi:ammonite-interp_2.13.12:3.0.0-M0-56-1bcbe7f6` for [`ammonite.interp.api.InterpApi`](api-ammonite.md#interpapi),
- `com.lihaoyi:ammonite-repl_2.13.12:3.0.0-M0-56-1bcbe7f6` for [`ammonite.repl.api.ReplAPI`](api-ammonite.md#replapi),
- `sh.almond:scala-kernel-api_2.13.12:0.14.0-RC14` for [`almond.api.JupyterApi`](api-jupyter.md#jupyterapi).
...
libraryDependencies ++= Seq(
  ("com.lihaoyi" % "ammonite-interp" % "3.0.0-M0-56-1bcbe7f6" % Provided).cross(CrossVersion.full), // for ammonite.interp.api.InterpApi
  ("com.lihaoyi" % "ammonite-repl" % "3.0.0-M0-56-1bcbe7f6" % Provided).cross(CrossVersion.full), // for ammonite.repl.api.ReplAPI
  ("sh.almond" % "scala-kernel-api" % "0.14.0-RC14" % Provided).cross(CrossVersion.full) // for almond.api.JupyterApi
)
```
