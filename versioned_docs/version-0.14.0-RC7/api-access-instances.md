...
id: version-0.14.0-RC7-api-access-instances
...
- `sh.almond:scala-kernel-api_2.13.11:0.14.0-RC7` for [`almond.api.JupyterApi`](api-jupyter.md#jupyterapi).
...
libraryDependencies ++= Seq(
  ...
  ("sh.almond" % "scala-kernel-api" % "0.14.0-RC7" % Provided).cross(CrossVersion.full) // for almond.api.JupyterApi
)
```
