---
title: Spark
id: version-0.13.14-usage-spark
...
import $ivy.`sh.almond::almond-spark:0.13.14` // Not required since almond 0.7.0 (will be automatically added when importing spark)
```
